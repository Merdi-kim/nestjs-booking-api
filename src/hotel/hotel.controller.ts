...
export class HotelController {
    ...
    getReservationsForHotel(@Param('hotelName') hotelName:string, @Body('owner') owner:string):Promise<string[] | number> {
    ...
    @Post(':hotelName/edit') 
    modifyHotelPrice(@Param('hotelName') hotelName:string, @Body('owner') owner:string, @Body('price', ParseIntPipe) price:number) {
